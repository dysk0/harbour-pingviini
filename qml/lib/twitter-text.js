...
var OPTIONS_NOT_ATTRIBUTES = {'urlClass':true, 'listClass':true, 'usernameClass':true, 'hashtagClass':true, 'cashtagClass':true,
                          ...
                          'usernameIncludeSymbol':false, 'suppressLists':true, 'suppressNoFollow':true, 'targetBlank':true,
...
twttr.txt.autoLinkEntities = function(text, entities, options) {
  ...
  options.cashtagUrlBase = options.cashtagUrlBase || "#";
  options.listClass = options.listClass || DEFAULT_LIST_CLASS;
  options.usernameClass = options.usernameClass || DEFAULT_USERNAME_CLASS;
  options.usernameUrlBase = options.usernameUrlBase || "@";
  options.listUrlBase = options.listUrlBase || "https://twitter.com/";
  options.htmlAttrs = twttr.txt.extractHtmlAttrsFromOptions(options);
  options.invisibleTagAttrs = options.invisibleTagAttrs || "";
